...
& = \sigma ([l_1] . [W_2]) \times (1- \sigma ([l_1] . [W_2])) * -w_2^1 \dots && \text{using \eqref{ref37}} \label{ref53} \tag{53}\\
& = \hat{y} \times (1- \hat{y}) * -w_2^1 \dots && \text{using \eqref{ref35}} \label{ref54} \tag{54}\\
\end{align}
$$
<!--
$$
