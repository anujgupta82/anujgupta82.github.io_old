...
$$
\begin{align}
\frac{\partial L}{\partial w_2^1} & = \frac{\partial L}{\partial \hat{y}} \times \frac{\partial \hat{y}}{\partial w_2^1} \label{ref41} \tag{41}\\
\frac{\partial L}{\partial \hat{y}} &= \frac{1}{2} \times 2 \times (y - \hat{y})^{1} \times (-1) \label{ref42} \tag{42}\\
\frac{\partial \hat{y}}{\partial w_2^1} &= \big{(} \frac{1}{1 + e^{-[l_1] . [W_2]}} \big{)} \times \big{(}1- \frac{1}{1 + e^{-[l_1] . [W_2]}} \big{)} * -l_1^1 \\
& = \sigma ([l_1] . [W_2]) \times (1- \sigma ([l_1] . [W_2])) * -l_1^1 \dots && \text{using \eqref{ref31}} \label{ref43} \tag{43}\\
& = \hat{y} \times (1- \hat{y}) * -l_1^1 \dots && \text{using \eqref{ref30}} \label{ref44} \tag{44}\\
\end{align}
$$

Substituting \eqref{ref43} & \eqref{ref44} in \eqref{ref41}, we get 

$$
\begin{align}
\frac{\partial L}{\partial w_2^1} &= \big{(} (-1) \times (y - \hat{y}) \big{)} \times \big{(} \hat{y} \times (1- \hat{y}) \times -l_1^1 \big{)}\\ \\
&= (y - \hat{y}) \times \hat{y} \times (1- \hat{y}) \times l_1^1 \label{ref45} \tag{45} \\
\end{align}
$$
...
\begin{align}
\Delta l_{2} = (y - \hat{y}) \times \hat{y} \times (1- \hat{y}) \label{ref46} \tag{46} \\
\end{align}

Then, eq \eqref{ref45} reduces to:   

$$ 
\begin{align}
\frac{\partial L}{\partial w_2^1} &= \Delta l_{2} \times l_1^1 \label{ref47} \tag{47} \\
\end{align}
$$
...
$$
\begin{align}
\frac{\partial L}{\partial w_2^2} & = \Delta l_{2} \times l_1^2 \label{ref48} \tag{48} \\
\end{align}
$$

Using eq \eqref{ref47} and \eqref{ref48} in \eqref{ref40} 
...
Lets, first compute \\(\frac{\partial L}{\partial w_{1}^{11}}\\):

$$
\begin{align}
\frac{\partial L}{\partial w_1^{11}} & = \frac{\partial L}{\partial \hat{y}} \times \frac{\partial \hat{y}}{\partial l_1^1} \times \frac{\partial l_1^1}{\partial w_1^{11}}\label{ref51} \tag{51}\\
\frac{\partial L}{\partial \hat{y}} &=  -(y - \hat{y})^{1} \label{ref52} \tag{52}\\
\frac{\partial \hat{y}}{\partial l_1^1} &= \big{(} \frac{1}{1 + e^{-[l_1] . [W_2]}} \big{)} \times \big{(}1- \frac{1}{1 + e^{-[l_1] . [W_2]}} \big{)} * -l_1^1 \\
& = \sigma ([l_1] . [W_2]) \times (1- \sigma ([l_1] . [W_2])) * -l_1^1 \dots && \text{using \eqref{ref31}} \label{ref53} \tag{53}\\
& = \hat{y} \times (1- \hat{y}) * -l_1^1 \dots && \text{using \eqref{ref30}} \label{ref54} \tag{54}\\
\end{align}
$$
<!--
$$
