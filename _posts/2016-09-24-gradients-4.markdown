...
$$ 
\begin{align}
\frac{\partial L}{\partial w_2^1} &= \Delta l_{2} \times l_1^1 \\
\end{align}
$$
...
$$
\begin{align}
\frac{\partial L}{\partial w_2^2} & = \Delta l_{2} \times l_1^2 \label{ref47} \tag{47} \\
\end{align}
$$

Using eq \eqref{ref45} and \eqref{ref47} in \eqref{ref40} 
...
$$
\frac{\partial L}{\partial W_1} = \left[ \begin{array}{c} l_1^1 \\ l_1^2 \end{array} \right]_{\scriptscriptstyle 2 \times 1}. \left[ \Delta l_{2} \right]_{\scriptscriptstyle 1 \times 1}
$$


$$ 
\begin{align}
\frac{\partial L}{\partial W_2} &= [(l_{1})^{T}] . \Delta l_{2} \\
