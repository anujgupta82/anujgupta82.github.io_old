...
$$
\begin{align}
l_1 & = \sigma ([X] . [W_1]) \label{ref31} \tag{31} \\
& = \frac{1}{1 + e^{-[X] . [W_1]}} \label{ref32} \tag{32}
\end{align}
$$
...
$$
\begin{align}
l_1 & = \sigma ([X] . [W_1]) \label{ref01} \tag{100} \\
& = \frac{1}{1 + e^{-[X] . [W_1]}} \label{ref101} \tag{101} \\
& = \frac{1}{1 + e^{-(x^1 \times w_1^1 + x^2 \times w_1^2 + x^3 \times w_1^3)}} \label{ref102} \tag{102} 
\end{align}
$$
...
$$
\begin{align}
l_1^1 = \frac{1}{1 + e^{-(x^1 \times w_1^11 + x^2 \times w_1^21 + x^3 \times w_1^31)}} \label{ref33} \tag{33} \\
l_1^2 = \frac{1}{1 + e^{-(x^1 \times w_1^12 + x^2 \times w_1^22 + x^3 \times w_1^32)}} \label{ref34} \tag{34} \\
\end{align}
$$

\\( \hat{y} \\) is output of layer 2 (\\(l_2\\)) as well as predicted output. In matrix format, \\([\hat{y}]_{\scriptscriptstyle 1\times 1}\\)

$$
\begin{align}
\hat{y} & = \sigma ([l_1] . [W_2]) \\
& = \frac{1}{1 + e^{-[l_1] . [W_2]}} \\
& = \frac{1}{1 + e^{-(l_1^1 W_2^1 + l_1^2 W_2^2)}}
\end{align}
$$
...
$$
\begin{align}
\frac{\partial L}{\partial W_2} & = \frac{\partial L}{\partial \hat{y}} \times \frac{\partial \hat{y}}{\partial W_2} \label{ref41} \tag{41}\\
\end{align}
$$
