...
$$
\begin{align}
\frac{\partial L}{\partial w_2^2} & = \Delta l_{2} \times l_1^2 \label{ref46} \tag{46} \\
\end{align}
$$

Using eq \eqref{ref45} and \eqref{ref46}  in \eqref{ref40} 

$$
\begin{equation}
\nabla_{W_2} L = \begin{bmatrix}
     \Delta l_{1} \times l_1^1 \\
     \Delta l_{1} \times l_1^2 \\
     \end{bmatrix}
\label{ref47} \tag{47}
\end{equation} 
$$
