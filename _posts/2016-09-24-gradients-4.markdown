...
$$
\begin{align}
\frac{\partial L}{\partial w_1^{21}} & = -(y - \hat{y}) \times \hat{y} \times (1- \hat{y}) * w_2^1 \times (l_1^1) \times (1-l_1^1) \times x^2 \label{ref158} \tag{58} \\
\end{align}
$$

$$
\begin{align}
\frac{\partial L}{\partial w_1^{31}} & = -(y - \hat{y}) \times \hat{y} \times (1- \hat{y}) * w_2^1 \times (l_1^1) \times (1-l_1^1) \times x^3 \label{ref159} \tag{59} \\
\end{align}
$$
...
\eqref{ref133}} \label{ref156} \tag{56}\\
\end{align}
-->
