...
\frac{\partial \hat{y}}{\partial W} &= \big{(} \frac{1}{1 + e^{-[X] . [W]}} \big{)} \times \big{(}1- \frac{1}{1 + e^{-[X] . [W]}} \big{)} * X \dots && \text{using [Eq C](https://anujgupta82.github.io/2016/08/24/gradients-0/#derivative-anchors)} \label{ref3} \tag{3}\\
