...
\begin{align}
\Delta l_{2} = (y - \hat{y}) \times \hat{y} \times (1- \hat{y}) \tag{46} \\
\end{align}
...
&= (\left[ \Delta l_{2} \right]_{\scriptscriptstyle 1 \times 1} . \left[ W_2 ^\intercal \right]_{\scriptscriptstyle 1 \times 2}) \times (l_1^1) \times (1-l_1^1) \label{ref179} \tag{79}
\end{align}
$$
...
Now, using 4 equations - \eqref{ref146}, \eqref{ref179}, \eqref{ref1491} and \eqref{ref178} one can directly code backpropagation algorithm