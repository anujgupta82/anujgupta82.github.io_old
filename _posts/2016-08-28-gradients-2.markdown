...
$$
\begin{align}
\hat{y} & = \sigma ([l_1] . [W_2]) \label{ref101} \tag{10.1} \\
& = \frac{1}{1 + e^{-[l_1] . [W_2]}} \label{ref102} \tag{10.2} \\
& = \frac{1}{1 + e^{-(l_1^1 w_2^1 + l_1^2 w_2^2)}} \label{ref103} \tag{10.3} \\
\end{align}
$$
...
& = \sigma ([X] . [W]) \times (1- \sigma ([X] . [W])) * -x_1 \dots & \text{using \eqref{ref10}} & \label{ref15} \tag{15}\\
& = \hat{y} \times (1- \hat{y}) * -x_1 \dots & \text{using \eqref{ref10}} & \label{ref16} \tag{16}\\
\end{align}
$$
