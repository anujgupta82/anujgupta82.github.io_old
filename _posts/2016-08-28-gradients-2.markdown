...
{% highlight r %} $$ \mathsf{Data = PCs} \times \mathsf{Loadings} $$ {% endhighlight %}
...
{% highlight r %} \[ \mathbf{X} = \mathbf{Z} \mathbf{P^\mathsf{T}} \] {% endhighlight %}
...
{% highlight r %} $$ \mathbf{X}_{n,p} = \mathbf{A}_{n,k} \mathbf{B}_{k,p} $$ {% endhighlight %}
