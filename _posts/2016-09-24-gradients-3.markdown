...
\frac{\partial L}{\partial W} &= \begin{bmatrix}
     ...
     \beta_1 \times x_{1}^{3} + \beta_2 \times x_{2}^{3} + \beta_3 \times x_{3}^{3} + \beta_4 \times x_{4}^{3} \\
     \end{bmatrix}
& = \begin{bmatrix} x_{1}^{1} & x_{2}^{1} & x_{3}^{1} & x_{4}^{1} \\ x_{1}^{2} & x_{2}^{2} & x_{3}^{2} & x_{4}^{2} \\ x_{1}^{3} & x_{2}^{3} & x_{3}^{3} & x_{4}^{3} \end{bmatrix} . \left[ \begin{array}{c} \beta_{1} \\\beta_{2} \\\beta_{3} \\\beta_{4} \end{array} \right]
\label{ref18} \tag{8}
\end{equation} 
$$
